                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="no_kk" class="form-control" id="" value="<?= $row['NO_KK']; ?>" placeholder="Masukkan No.KK">
                        </div>
                        <div class="form-group">
                            <label for="">NIK</label>
                            <input type="number" name="nik" class="form-control" id="" value="<?= $nik; ?>" placeholder="Masukkan NIK" readonly>
                        </div>
                        <div class="form-group">
