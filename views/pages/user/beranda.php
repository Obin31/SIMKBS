            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                        <h1>Sistem Informasi Kependudukan <br> 
                        & Bantuan Sosial</h1>
                        <p style="text-align: justify;">
                            Sistem Informasi Kependudukan dan Bantuan Sosial atau bisa disingkat SIKBS merupakan suatu sistem yang dapat mengolah data kependudukan yang berada di <?= $row_profil->nama_desa; ?> menjadi Data Klasifikasi kependudukan dan Data Klasifikasi Bantuan.
                        </p>
                        <div>
                    ...
                    <div class="col-lg-6 order-1 order-lg-2 hero-img">
                        <img src="<?= $base_url; ?>asset_user/img/data.png" class="img-fluid animated" alt="">
                    </div>
                </div>
            </div>
        </section>
    ...
    <div class="carousel-item" data-bs-interval="10000">
        <section id="hero" class="d-flex align-items-center">
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                        <h1>Sistem Informasi Kependudukan Slide kedua<br> 
                        & Bantuan Sosial</h1>
                        <p style="text-align: justify;">
                            Sistem Informasi Kependudukan dan Bantuan Sosial atau bisa disingkat SIKBS merupakan suatu sistem yang dapat mengolah data kependudukan yang berada di <?= $row_profil->nama_desa; ?> menjadi Data Klasifikasi kependudukan dan Data Klasifikasi Bantuan.
                        </p>
    ...
    <div class="carousel-item" data-bs-interval="10000">
        <section id="hero" class="d-flex align-items-center">
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                        <h1>Sistem Informasi Kependudukan Slide Ketiga<br> 
                        & Bantuan Sosial</h1>
                        <p style="text-align: justify;">
                            Sistem Informasi Kependudukan dan Bantuan Sosial atau bisa disingkat SIKBS merupakan suatu sistem yang dapat mengolah data kependudukan yang berada di <?= $row_profil->nama_desa; ?> menjadi Data Klasifikasi kependudukan dan Data Klasifikasi Bantuan.
                        </p>
        ...
        <div class="row justify-content-center mt-5">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-7 text-center">
                    <h2 style="font-size: 1.5rem;">Persyaratan Penerima Bantuan</h2>
                    <p>
                    1. Berikut Ini Adalah Kriteria Penerima PKH Kesehatan:<br>
                        -Ibu hamil atau menyusui, dengan batasan maksimal dua kali kehamilan.<br>
                        -Anak usia 0-6 tahun, dengan batasan maksimal dua anak.<br><br>
                    2. Berikut Ini Adalah Kriteria Penerima PKH Pendidikan:<br>
                        -Anak Sekolah Dasar (SD), Madrasah Ibtidaiyah (MI), atau tingkat pendidikan yang setara.<br>
                        -Anak Sekolah Menengah Pertama (SMP), Madrasah Tsanawiyah, atau tingkat pendidikan yang setara.<br>
                        -Anak Sekolah Menengah Atas (SMA), Madrasah Aliyah, atau tingkat pendidikan yang setara.<br>
                        -Anak usia 6-21 tahun yang belum menyelesaikan wajib belajar 12 tahun.<br><br>
                    3. Berikut Ini Adalah Kriteria Penerima PKH Sosial:<br>
                        -Lanjut usia di atas 60 tahun, dengan batasan maksimal 1 orang dalam satu keluarga.<br>
                        -Penyandang disabilitas, dengan prioritas pada penyandang disabilitas berat serta batasan maksimal 1 orang dalam satu keluarga.<br>
                    </p>
                </div>
                    </p>
                </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/6461855274285f0ec46b6ddb/1h0ef1j7i';
s1.charset='UTF-8';
